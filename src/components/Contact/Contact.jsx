...
const Contact = () => {
  ...
  return (
    <div id="contact" className="sm:py-16 min-h-[90vh]">
      <div className="wrapper mx-auto">
        <h1 className="mt-14 text-xl uppercase text-[#0284c7] text-center font-semibold mb-5">
          Contact
        </h1>
        <div className="mb-14 grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
          <form
            ref={form}
